...
export default function Hero() {
    ...
    return (
        <section className="h-[500px] flex flex-col items-center text-secondary" id="home">
            ...
            <div className="container flex flex-col items-center gap-16 mt-20 px-4 w-full sm:flex-row sm:mt-20 sm:justify-between md:mt-40 lg:absolute lg:top-1/3 lg:pt-8">
            ...
            <div className="relative flex justify-center overflow-hidden min-h-120 w-full min-w-[360px]">
